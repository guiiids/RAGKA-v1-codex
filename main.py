...
def get_rag_assistant(session_id):
    ...
    if session_id not in rag_assistants:
        ...
        if redis_service.is_connected():
            ...
            logger.warning(f"Redis not available for session {session_id}")
...
def api_register_session_citations():
    ...
    try:
        ...
        registered_sources = session_citation_registry.register_sources(session_id, sources)
...
def api_get_session_citation():
    ...
    try:
        ...
        source_data = session_citation_registry.get_source_by_citation_id(session_id, citation_id_int)
...
def api_get_all_session_citations():
    ...
    try:
        ...
        all_citations = session_citation_registry.get_all_session_citations(session_id)
...
def api_clear_session_citations():
    ...
    try:
        ...
        success = session_citation_registry.clear_session_citations(session_id)
...
def api_session_citation_stats():
    ...
    try:
        ...
        stats = session_citation_registry.get_citation_stats(session_id)
