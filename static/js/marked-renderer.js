...
document.addEventListener('DOMContentLoaded', () => {
  ...
  async function fetchAndRenderMarkdown(query) {
    try {
      ...
      // If the answer HTML already contains citation-link markup, insert as is; otherwise, use marked for pure markdown
      let html;
      if (markdown.includes('class="citation-link"')) {
        html = markdown;
        console.log("marked-renderer.js: Answer contains citation-link anchors, skipping marked parsing.");
      } else {
